...
{
    return [self.DeviceInfo[deviceName][SSDeviceWidth] integerValue];
}

+ (NSInteger)deviceHeightWithDevice:(NSString *)deviceName
{
    return [self.DeviceInfo[deviceName][SSDeviceHeight] integerValue];
}

+ (NSInteger)deviceDepthWithDevice:(NSString *)deviceName
{
    return [self.DeviceInfo[deviceName][SSDeviceDepth] integerValue];
}

+ (NSString *)deviceSizeWithDevice:(NSString *)deviceName
{
    return [NSString stringWithFormat:@"%ld mm x %ld mm x %ld mm",
